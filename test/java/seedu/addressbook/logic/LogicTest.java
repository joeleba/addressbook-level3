...
public class LogicTest {
     ...
     *      - the storage file content matches data in {@code expectedAddressBook} if the command mutates the data <br>
     */
    private void assertCommandBehavior(String inputCommand,
        ...
        // Since test data is generated by methods rather than commands,
        // we only test content of the save file if the command mutates it
