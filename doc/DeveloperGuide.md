...
`* *` | user | add tags to an existing person | update tags without having to delete existing person and create a new one
`* *` | user | delete tags from an existing person | update tags without having to delete existing person and create a new one
...
5. Should have colorful UI.
6. Should not take up more than 10MB of RAM while running.
